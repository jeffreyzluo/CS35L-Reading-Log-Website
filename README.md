...
```bash
git clone https://github.com/jeffreyzluo/CS35L-Reading-Log-Website.git
```
...
After setting up the postgreSQL database and other API keys, follow the instructions below:
